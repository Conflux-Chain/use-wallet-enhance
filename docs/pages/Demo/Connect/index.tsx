...
import { use20Balance, startTrack } from '../../../store';
...
const ConnectDemo: React.FC = () => {
    ...
    console.log('20balance: ', c20Balance?.toDecimalStandardUnit(), ', status:', status, ' , account:', account, ' , chainId:', chainId);
